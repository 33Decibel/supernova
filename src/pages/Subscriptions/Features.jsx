        ...
        <form className='group/tiers isolate overflow-hidden'>
          <div className='relative  dark:bg-gray-900'>
            <div className=' pt-16'>
              ...
              <h4 className='text-xl font-bold mb-2'>Compare Features</h4>
              <section
                ...
                <div className='-mt-6 space-y-16'>
                  {pricing.sections.map((section) => (
                    <div key={section.name}>
                      ...
                      <div className='relative -mx-[31px] mt-10'>
                        ...
                        <table className='relative w-full border-separate border-spacing-x-8 mb-[2px] me-[2px]'>
                          <thead>
